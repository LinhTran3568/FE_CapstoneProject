    ...
    >
            ...
            {listing.sellerFullName && (
              <div className="flex items-center gap-1.5 shrink-0">
                ...
                <span className="font-medium text-zinc-300">
                  Người bán: <span className="text-[#10b981] font-semibold">{listing.sellerFullName}</span>
                </span>
              </div>
            )}
          </div>
      ...
      >
        ...
        <div className="flex items-center justify-between pt-0.5">
          ...
          <div className="flex items-center gap-[2px] h-5 opacity-80" title="Mã vạch soát vé">
        ...
        <div className="my-auto py-1">
          ...
          <div className="flex items-baseline">
            ...
            <span className="ml-1 text-sm font-bold text-slate-700">đ</span>
          </div>

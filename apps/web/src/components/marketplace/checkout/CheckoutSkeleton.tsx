...
export const CheckoutSkeleton: React.FC = () => {
  return (
    <div className="w-full space-y-3 animate-pulse">
      ...
      <div className="h-10 rounded-xl bg-[#1A2335] border border-[#28354D] px-3.5 py-2 flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5">
        ...
        <div className="lg:col-span-5 rounded-2xl bg-[#1A2335] border border-[#28354D] p-4 flex flex-col items-center justify-between min-h-[290px]">
        ...
        <div className="lg:col-span-7 space-y-2.5">
          ...
          <div className="rounded-xl border border-[#28354D] bg-[#1A2335] p-3 space-y-2">
            <div className="grid grid-cols-2 gap-2 pb-2 border-b border-[#28354D]">

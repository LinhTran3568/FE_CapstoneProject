            ...
            <div className="w-full max-w-lg mt-2 space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                >
                  ...
                  <div className="text-[10px] text-zinc-400">3,600,000 VND</div>
                </button>
                ...
                >
                  ...
                  <div className="text-[10px] text-zinc-400">1,650,000 VND</div>
                </button>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-xs text-zinc-400">2,250,000 VND • Popular</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs text-zinc-400">2,100,000 VND</div>
                </button>
              </div>
              ...
              >
                <div className="text-xs font-bold text-blue-300">GA STANDING (GENERAL ADMISSION)</div>
                <div className="text-[10px] text-zinc-400">950,000 VND • Budget</div>
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {zones.map((z) => (
              ...
              >
                ...
                <div className="text-sm font-extrabold text-white font-display">{z.price}</div>
              </button>
            ))}
          </div>
        </div>

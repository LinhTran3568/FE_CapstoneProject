      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-r from-[#0A0D12] via-[#0F141C] to-[#0A0D12] border border-[#FF5A36]/30 p-6 md:p-8 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="space-y-2 relative z-10">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold font-display text-white tracking-tight">
              Welcome, <span className="text-[#FF5A36]">{user?.fullName || 'Partner'}</span>!
            </h2>
            <p className="text-sm text-[#A3A8B3] max-w-2xl leading-relaxed">
              Manage your verified tickets with confidence. All transactions are protected by 24-Hour Funds Protection and Official Organizer Re-issuance.
            </p>
          </div>
          ...
          <div className="relative z-10 flex items-center gap-3 w-full md:w-auto">
            <button
              ...
              className="flex-1 md:flex-none px-6 py-3 bg-[#FF5A36] hover:bg-[#FF7252] text-white font-bold font-display text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-[#FF5A36]/30 hover:shadow-[#FF5A36]/50 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
              <PlusCircle className="w-4 h-4" />
              <span>+ List New Ticket</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-[#0A0D12] border border-white/10 p-5 rounded-2xl space-y-3 hover:border-[#FF5A36]/40 transition-colors">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#A3A8B3] font-display uppercase tracking-wider">Active Listings</span>
            ...
            <div className="flex items-baseline justify-between">
              <span className="text-2xl font-bold font-display text-white">
                {activeListingsCount} <span className="text-xs font-normal text-[#A3A8B3]">tickets</span>
              </span>
              <span className="text-xs text-emerald-400 font-mono flex items-center gap-0.5">
                <TrendingUp className="w-3 h-3" /> Auto-synced
              </span>
            </div>
          ...
          <div className="bg-[#0A0D12] border border-white/10 p-5 rounded-2xl space-y-3 hover:border-cyan-500/40 transition-colors">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#A3A8B3] font-display uppercase tracking-wider">Total Active Value</span>
            ...
            <div className="flex items-baseline justify-between">
              <span className="text-2xl font-bold font-display text-white">
                {totalEscrowVnd.toLocaleString('vi-VN')} <span className="text-xs font-normal text-[#A3A8B3]">VND</span>
              </span>
              <span className="text-xs text-cyan-400 font-mono">Listed</span>
            </div>
            <div className="w-full bg-white/5 h-1.5 rounded-full overflow-hidden">
          ...
          <div className="bg-[#0A0D12] border border-white/10 p-5 rounded-2xl space-y-3 hover:border-emerald-500/40 transition-colors">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#A3A8B3] font-display uppercase tracking-wider">Total Settled Revenue</span>
              <div className="p-2 rounded-xl bg-emerald-500/10 text-emerald-400">
                <Wallet className="w-5 h-5" />
              </div>
            </div>
            <div className="flex items-baseline justify-between">
              <span className="text-2xl font-bold font-display text-white">32,500,000 <span className="text-xs font-normal text-[#A3A8B3]">VND</span></span>
              <span className="text-xs text-emerald-400 font-mono">Settled</span>
            </div>
            <div className="w-full bg-white/5 h-1.5 rounded-full overflow-hidden">
          ...
          <div className="bg-[#0A0D12] border border-white/10 p-5 rounded-2xl space-y-3 hover:border-amber-500/40 transition-colors">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#A3A8B3] font-display uppercase tracking-wider">Seller Trust Score</span>
              <div className="p-2 rounded-xl bg-amber-500/10 text-amber-400">
                <FileCheck className="w-5 h-5" />
              </div>
            </div>
            <div className="flex items-baseline justify-between">
              <span className="text-2xl font-bold font-display text-white">99.8% <span className="text-xs font-normal text-[#A3A8B3]">Verified Rate</span></span>
              <span className="text-xs text-amber-400 font-mono">Platinum Tier</span>
            </div>
            <div className="w-full bg-white/5 h-1.5 rounded-full overflow-hidden">
        ...
        <div id="my-listings" className="bg-[#0A0D12] border border-white/10 rounded-2xl p-4 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-xs font-display text-[#A3A8B3] uppercase tracking-wider">
            ...
            <span>Quick Reseller Tools:</span>
          </div>
          <div className="flex flex-wrap items-center gap-3 text-xs font-medium">
            <button
              onClick={() => navigate('/sell-ticket')}
              className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:border-[#FF5A36]/40 transition-all flex items-center gap-1.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-all flex items-center gap-1.5 cursor-pointer"
            >
              <Ticket className="w-3.5 h-3.5 text-cyan-400" />
              <span>View My Listings ({activeListingsCount})</span>
            </button>
          </div>
        </div>
